...
const FileData_js_1 = __importDefault(require("./FileData.js"));
class FormData {
    constructor(nest) {
        this.nest = nest;
    }
    set(...path) {
        ...
        if (!boundary) {
            throw Exception_js_1.default.for('Invalid form data');
        }
        let part = [];
    ...
    _setPart(path, part) {
        ...
        this.nest.set(...paths, new FileData_js_1.default({
            data: part.body,
