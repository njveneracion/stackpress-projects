...
const Alter_js_1 = __importDefault(require("./builder/Alter.js"));
const Create_js_1 = __importDefault(require("./builder/Create.js"));
const Delete_js_1 = __importDefault(require("./builder/Delete.js"));
const Insert_js_1 = __importDefault(require("./builder/Insert.js"));
const Select_js_1 = __importDefault(require("./builder/Select.js"));
const Update_js_1 = __importDefault(require("./builder/Update.js"));
...
class Engine {
    ...
    alter(table) {
        return new Alter_js_1.default(table, this);
    }
    create(table) {
        return new Create_js_1.default(table, this);
    }
    delete(table) {
        return new Delete_js_1.default(table, this);
    }
    diff(from, to) {
        const build = {
            from: from.build(),
        ...
        for (const name in build.from.unique) {
            ...
            if (!(0, helpers_js_1.jsonCompare)(build.from.unique[name], build.to.unique[name])) {
                alter.removeUniqueKey(name);
        ...
        for (const name in build.from.keys) {
            ...
            if (!(0, helpers_js_1.jsonCompare)(build.from.keys[name], build.to.keys[name])) {
                alter.removeKey(name);
        ...
        for (const name in build.from.foreign) {
            ...
            if (!(0, helpers_js_1.jsonCompare)(build.from.foreign[name], build.to.foreign[name])) {
                alter.removeForeignKey(name);
    ...
    insert(table) {
        return new Insert_js_1.default(table, this);
    }
    query(query, values = []) {
    ...
    select(columns) {
        return new Select_js_1.default(columns, this);
    }
    sql(strings, ...values) {
    ...
    update(table) {
        return new Update_js_1.default(table, this);
    }
}
