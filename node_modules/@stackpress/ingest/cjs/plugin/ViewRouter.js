...
class ViewRouter {
    ...
    action(event, action, priority = 0) {
        ...
        (_a = this.views.get(event)) === null || _a === void 0 ? void 0 : _a.add({ entry: action, priority });
        const router = this;
        return function TemplateFileAction(req, res, ctx) {
            return __awaiter(this, void 0, void 0, function* () {
                if (!router._engine)
                    return;
                yield router._engine(action, req, res, ctx);
            });
        };
    }
    ...
    use(router) {
        router.views.forEach((tasks, event) => {
            ...
            tasks.forEach(task => { var _a; return (_a = this.views.get(event)) === null || _a === void 0 ? void 0 : _a.add(task); });
        });
        return this;
    }
}
