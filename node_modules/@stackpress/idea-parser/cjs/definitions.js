...
exports.data = exports.scalar = void 0;
exports.scan = scan;
...
const definitions = {
    ...
    'Array': (code, index, lexer) => {
        ...
        try {
            ...
            while (subparser.next(exports.data)) {
                const value = subparser.expect(exports.data);
                subparser.optional('whitespace');
                elements.push(value);
            }
            subparser.expect(']');
...
exports.data = [...exports.scalar, 'Object', 'Array'];
function scan(type, regexp, code, start) {
...
function reader(type, regexp, code, index) {
    let value = '';
    let matched = false;
    const start = index;
...
function identifier(regexp, code, index) {
