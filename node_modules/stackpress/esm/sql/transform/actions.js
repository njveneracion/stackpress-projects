...
;
export function batch(model, directory) {
...
;
export function create(model, directory) {
...
;
export function detail(model, directory) {
...
;
export function get(model, directory) {
...
;
export function remove(model, directory) {
...
;
export function restore(model, directory) {
...
;
export function search(model, directory) {
...
;
export function update(model, directory) {
...
;
export function upsert(model, directory) {
