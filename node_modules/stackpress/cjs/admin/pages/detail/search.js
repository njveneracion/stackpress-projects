...
exports.default = AdminDetailSearchPageFactory;
function AdminDetailSearchPageFactory(model) {
    return function AdminDetailSearchPage(req, res, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ids.length === model.ids.length) {
                const response = yield ctx.resolve(`${model.dash}-detail`, req, res);
                if (!res.body) {
