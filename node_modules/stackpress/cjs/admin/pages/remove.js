...
exports.default = AdminRemovePageFactory;
function AdminRemovePageFactory(model) {
    return function AdminRemovePage(req, res, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ids.length === model.ids.length) {
                if (req.data('confirmed')) {
                    yield ctx.emit(`${model.dash}-remove`, req, res);
                    if (res.code !== 200) {
