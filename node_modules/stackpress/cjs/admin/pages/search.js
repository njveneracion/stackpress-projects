...
exports.default = AdminSearchPageFactory;
function AdminSearchPageFactory(model) {
    return function AdminSearchPage(req, res, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield ctx.resolve(`${model.dash}-search`, { q, filter, span, sort, skip, take, columns }, res);
            if (res.code !== 200) {
