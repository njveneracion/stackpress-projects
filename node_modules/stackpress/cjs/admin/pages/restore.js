...
exports.default = AdminRestorePageFactory;
function AdminRestorePageFactory(model) {
    return function AdminRestorePage(req, res, ctx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ids.length === model.ids.length) {
                if (req.data('confirmed')) {
                    yield ctx.emit(`${model.dash}-restore`, req, res);
                    if (res.code !== 200) {
                        yield ctx.emit('error', req, res);
                        return;
                    }
                ...
                yield ctx.emit(`${model.dash}-detail`, req, res);
                if (res.code !== 200) {
                    yield ctx.emit('error', req, res);
                    return;
                }
