...
class Fieldset {
    ...
    get camel() {
        return (0, helpers_js_1.camelize)(this.name);
    }
    get dash() {
    ...
    get defaults() {
        ...
        for (const column of this.columns.values()) {
            if (column.default === undefined
                || helpers_js_1.generators.includes(column.default)) {
                continue;
            }
    ...
    constructor(registry, name, attributes, columns) {
        ...
        this.name = name;
        this.attributes = new Attributes_js_1.default(Object.entries(attributes));
        this.columns = new Map(columns.map(info => [info.name, new Column_js_1.default(this, info)]));
    }
    ...
    render(data) {
        ...
        return mustache_1.default.render(this.template, data);
    }
