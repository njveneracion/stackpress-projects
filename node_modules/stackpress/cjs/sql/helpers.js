...
exports.intable = exports.boolable = exports.dateable = exports.floatable = exports.stringable = void 0;
...
exports.toSqlInteger = toSqlInteger;
exports.toSqlFloat = toSqlFloat;
exports.sequence = sequence;
exports.getColumns = getColumns;
exports.getColumnInfo = getColumnInfo;
exports.getColumnPath = getColumnPath;
exports.getColumnJoins = getColumnJoins;
exports.getAlias = getAlias;
const Exception_js_1 = __importDefault(require("../Exception.js"));
exports.stringable = ['String', 'Text', 'Json', 'Object', 'Hash'];
exports.floatable = ['Number', 'Float'];
exports.dateable = ['Date', 'Time', 'Datetime'];
exports.boolable = ['Boolean'];
exports.intable = ['Integer'];
function toErrorResponse(e, code = 400) {
    if (typeof e.toResponse !== 'function') {
        e = Exception_js_1.default.upgrade(e, code);
    }
    const error = e;
    return error.toResponse();
}
;
function toResponse(results, total) {
...
;
function toSqlString(value, strict = false) {
...
function toSqlBoolean(value, strict = false) {
    if (typeof value === 'undefined') {
...
function toSqlDate(value, strict = false) {
    if (!strict) {
        if (typeof value === 'undefined') {
            return undefined;
        }
...
function toSqlInteger(value, strict = false) {
    if (typeof value === 'undefined') {
...
function toSqlFloat(value, strict = false) {
    if (typeof value === 'undefined') {
        return (strict ? 0 : undefined);
    }
    else if (value === null) {
...
function getColumns(column, model, prefixes = []) {
    if (column === '*') {
        const columns = [];
...
function getColumnInfo(selector, model) {
    const name = selector;
...
function getColumnPath(selector, model, path = []) {
...
function getColumnJoins(selector, model, index = 0, joins = {}) {
    const selectors = selector.split('.');
    ...
    else if ((column === null || column === void 0 ? void 0 : column.related) && !(column === null || column === void 0 ? void 0 : column.related.parent.column.multiple)) {
