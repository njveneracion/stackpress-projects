...
function drop(server, database, cli) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (queries.length) {
            (cli === null || cli === void 0 ? void 0 : cli.verbose) && cli.control.system('Dropping database...');
            ...
            (cli === null || cli === void 0 ? void 0 : cli.verbose) && cli.control.success('Database Dropped.');
        }
    });
}
;
