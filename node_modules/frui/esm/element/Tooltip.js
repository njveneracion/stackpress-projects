...
export default function Tooltip(props) {
    ...
    return (_jsxs("div", { ref: buttonRef, className: "frui-tooltip-container", onMouseEnter: () => visible(true), onMouseLeave: () => visible(false), children: [children, isVisible && (_jsxs("div", { ref: tooltipRef, className: `${map.classes} ${arrow ? 'frui-tooltip-arrow-container' : ''}`, style: {
                    ...map.styles,
                    ...tooltipStyle,
                    ...opacityStyle,
                    ...paddingStyle,
                    ...(color ? { '--arrow-color': color } : {}),
                }, children: [text, arrow && direction && (_jsx("div", { className: `frui-tooltip-arrow ${color
                            ? 'custom-color'
                            : info
                                ? 'info'
                                : warning
