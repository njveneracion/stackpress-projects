...
import ColorDisplay from '../format/Color';
export const defaultHsva = { h: 208, s: 61, v: 89, a: 0.75 };
...
;
export function useColorPicker(config) {
    const { value, defaultValue = defaultRgbaString, onChange } = config;
    const isControlled = value !== undefined;
    const [displayPicker, setDisplayPicker] = useState(false);
    const [isDragging, setIsDragging] = useState(null);
    const [internalHsva, setInternalHsva] = useState(() => {
    ...
    const refs = {
        ...
        wrapper: useRef(null),
        palette: useRef(null),
        hueSlider: useRef(null),
        alphaSlider: useRef(null)
    };
    const handlers = {
        colorDisplayClick: () => setDisplayPicker(prev => !prev),
        clickOutside: useCallback((event) => {
...
export default function ColorPicker(props) {
    const { value, defaultValue = defaultRgbaString, onChange, showAlpha = true, showInputs = true, swatches = [], className, style, pickerStyle, pickerClassName, box = true, text = true, sm, md, lg, } = props;
    ...
    return (_jsxs("div", { ref: refs.wrapper, className: wrapperClasses, style: style, children: [_jsx("div", { onClick: handlers.colorDisplayClick, className: "frui-colorpicker-trigger", role: "button", "aria-haspopup": "true", "aria-expanded": displayPicker, children: _jsx(ColorDisplay, { ...colorProps }) }), displayPicker && (_jsxs("div", { ref: refs.picker, className: popoverClasses, style: dynamicPopoverStyles, onClick: e => e.stopPropagation(), children: [_jsxs("div", { ref: refs.palette, className: "frui-colorpicker-palette", onMouseDown: e => handlers.mouseDown('palette', e), style: { backgroundColor: hueColor }, children: [_jsx("div", { className: "frui-colorpicker-palette-saturation" }), _jsx("div", { className: "frui-colorpicker-palette-value" }), _jsx("div", { className: "frui-colorpicker-palette-pointer" })] }), _jsxs("div", { className: "frui-colorpicker-sliders", children: [_jsxs("div", { className: "frui-colorpicker-slider-container", children: [_jsx("label", { htmlFor: "frui-cp-hue-slider", style: {
                                            position: 'absolute',
                                            width: '1px',
                                            height: '1px',
                                            margin: '-1px',
                                            overflow: 'hidden',
                                            clip: 'rect(0, 0, 0, 0)'
                                        }, children: "Hue" }), _jsx("input", { id: "frui-cp-hue-slider", ref: refs.hueSlider, type: "range", min: "0", max: "360", value: hsva.h, onMouseDown: e => handlers.mouseDown('hue', e), onChange: handlers.hueChange, className: "frui-colorpicker-slider frui-colorpicker-slider-hue" })] }), showAlpha && (_jsxs("div", { className: "frui-colorpicker-slider-container", children: [_jsx("label", { htmlFor: "frui-cp-alpha-slider", style: {
                                            position: 'absolute',
                                            width: '1px',
                                            height: '1px',
                                            margin: '-1px',
                                            overflow: 'hidden',
                                            clip: 'rect(0, 0, 0, 0)'
                                        }, children: "Alpha" }), _jsx("input", { id: "frui-cp-alpha-slider", ref: refs.alphaSlider, type: "range", min: "0", max: "1", step: "0.01", value: hsva.a, onMouseDown: e => handlers.mouseDown('alpha', e), onChange: handlers.alphaChange, className: "frui-colorpicker-slider frui-colorpicker-slider-alpha" })] }))] }), showInputs && (_jsx("div", { className: "frui-colorpicker-inputs", children: _jsxs("div", { className: "frui-colorpicker-input-group", children: [_jsxs("div", { children: [_jsx("input", { id: "frui-cp-r", type: "number", min: "0", max: "255", value: currentRgba.r, onChange: e => handlers.rgbaInputChange('r', e.target.value), className: "frui-colorpicker-input-field" }), _jsx("label", { htmlFor: "frui-cp-r", className: "frui-colorpicker-input-label", children: "R" })] }), _jsxs("div", { children: [_jsx("input", { id: "frui-cp-g", type: "number", min: "0", max: "255", value: currentRgba.g, onChange: e => handlers.rgbaInputChange('g', e.target.value), className: "frui-colorpicker-input-field" }), _jsx("label", { htmlFor: "frui-cp-g", className: "frui-colorpicker-input-label", children: "G" })] }), _jsxs("div", { children: [_jsx("input", { id: "frui-cp-b", type: "number", min: "0", max: "255", value: currentRgba.b, onChange: e => handlers.rgbaInputChange('b', e.target.value), className: "frui-colorpicker-input-field" }), _jsx("label", { htmlFor: "frui-cp-b", className: "frui-colorpicker-input-label", children: "B" })] }), showAlpha && (_jsxs("div", { children: [_jsx("input", { id: "frui-cp-a", type: "number", min: "0", max: "1", step: "0.01", value: currentRgba.a.toFixed(2), onChange: e => handlers.rgbaInputChange('a', e.target.value), className: "frui-colorpicker-input-field" }), _jsx("label", { htmlFor: "frui-cp-a", className: "frui-colorpicker-input-label", children: "A" })] }))] }) })), swatches && swatches.length > 0 && (_jsx("div", { className: "frui-colorpicker-swatches", children: swatches.map((swatchColor, index) => {
                            ...
                            return (_jsx("div", { className: "frui-colorpicker-swatch", title: swatchColor, onClick: () => handlers.swatchClick(swatchColor), role: "button", "aria-label": `Select color ${swatchColor}`, children: _jsx("div", { className: "frui-colorpicker-swatch-color", style: swatchStyle }) }, `${swatchColor}-${index}`));
                        }) }))] }))] }));
}
;
