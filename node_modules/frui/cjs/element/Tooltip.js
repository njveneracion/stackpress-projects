...
function Tooltip(props) {
    const { text, children, color, info, warning, success, error, muted, curved, rounded, pill, style, className, top, bottom, left, right, opacity, arrow, padding, } = props;
    const [isVisible, visible] = (0, react_1.useState)(false);
    const [tooltipStyle, setTooltipStyle] = (0, react_1.useState)({});
    const [direction, setDirection] = (0, react_1.useState)(null);
    ...
    const map = {
        ...
        styles: Object.assign(Object.assign({}, defaults.styles), style),
    };
    (0, react_1.useEffect)(() => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { ref: buttonRef, className: "frui-tooltip-container", onMouseEnter: () => visible(true), onMouseLeave: () => visible(false), children: [children, isVisible && ((0, jsx_runtime_1.jsxs)("div", { ref: tooltipRef, className: `${map.classes} ${arrow ? 'frui-tooltip-arrow-container' : ''}`, style: Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, map.styles), tooltipStyle), opacityStyle), paddingStyle), (color ? { '--arrow-color': color } : {})), children: [text, arrow && direction && ((0, jsx_runtime_1.jsx)("div", { className: `frui-tooltip-arrow ${color
                            ? 'custom-color'
                            : info
                                ? 'info'
                                : warning
