...
function useNumber(config) {
    ...
    const [hiddenValue, setHiddenValue] = (0, react_1.useState)(initial.value);
    const [displayValue, setDisplayValue] = (0, react_1.useState)(initial.display);
...
function NumberField(props) {
    const { name, value, defaultValue, min, max, separator = ',', decimal = '.', step, absolute = false, controls, onUpdate, onChange } = props, attributes = __rest(props, ["name", "value", "defaultValue", "min", "max", "separator", "decimal", "step", "absolute", "controls", "onUpdate", "onChange"]);
    ...
    return ((0, jsx_runtime_1.jsx)(Input_js_1.default, Object.assign({ passRef: handlers.passRef }, attributes, { onChange: handlers.format, onBlur: handlers.defocus, value: displayValue })));
}
;
