...
function useTextarea({ onChange, onUpdate }) {
    return {
        handlers: {
            change: (e) => {
                onChange && onChange(e);
...
function Textarea(props) {
    ...
    return ((0, jsx_runtime_1.jsx)("textarea", Object.assign({}, attributes, { className: classNames.join(' '), ref: passRef, onChange: handlers.change })));
}
;
